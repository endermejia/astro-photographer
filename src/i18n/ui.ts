...
export const routes = {
	es: {
		albumsclimbing: 'albumes/escalada',
		albumspeople: 'albumes/personas',
		albumsevents: 'albumes/eventos',
		albumsbusiness: 'albumes/negocios',
		albumstravel: 'albumes/viajes'
	},
	en: {
		albumsclimbing: 'albums/climbing',
		albumspeople: 'albums/people',
		albumsevents: 'albums/events',
...
export const ui = {
	es: {
		...
		'header.title': `Hola! Soy Ainhoa,`,
		'header.subtitle': 'Escalada - Eventos - Retratos - Viajes',
		'about.title': `📸 Sobre mí`,
		'about.p1': `Soy Nhoa. Combino mis dos grandes amores: la fotografía y la escalada, para contar historias auténticas, ya sea en la cima de una montaña, en un evento vibrante o en la calidez de un retrato.`,
		'about.p2': `Busco capturar la emoción real en cada instante, transmitiendo la esencia de cada persona, marca o lugar.`,
		'about.p3': ``,
		'about.p4': `¿Buscas a alguien que capture lo que te hace única/o?`,
		'about.p5': `Estoy aquí para ayudarte a crear imágenes que inspiren y cuenten tu historia.`,
		'about.contact': `📩 Contactar con Nhoa`,
		'photos.title': 'Fotos',
		'photos.climbing': 'Escalada',
		'photos.people': 'Personas',
		'photos.events': 'Eventos',
	...
	en: {
		...
		'nav.photos': `Photos`,
		'nav.contact': `Contact`,
		'header.title': `Hi! I'm Ainhoa,`,
		'header.subtitle': 'Climbing - Events - Portraits - Travel',
		'about.title': `📸 About me`,
		'about.p1': `I'm Nhoa. I combine my two great loves: photography and climbing, to tell authentic stories, whether at the top of a mountain, at a vibrant event, or in the warmth of a portrait.`,
		'about.p2': `I seek to capture real emotion in every moment, transmitting the essence of every person, brand, or place.`,
		'about.p3': ``,
		'about.p4': `Looking for someone to capture what makes you unique?`,
		'about.p5': `I'm here to help you create images that inspire and tell your story.`,
		'about.contact': `📩 Contact Nhoa`,
		'photos.title': 'Photos',
		'photos.climbing': 'Climbing',
