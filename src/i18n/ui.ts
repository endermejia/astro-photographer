...
export const ui = {
	es: {
		...
		'about.p2': `Busco la autenticidad, no los posados perfectos. Trabajo con personas, marcas y deportistas que quieren contar su historia con fuerza y sensibilidad.`,
		'about.p3': ``,
		'about.p4': `¿Tienes una idea en mente?`,
		'about.p5': `¡Hablemos y diseñemos tu sesión ideal!`,
		'about.contact': `Hablemos de tu idea`,
		'about.quote': `Capturando la vida en vertical y las emociones a pie de calle.`,
		'photos.title': 'Fotos',
	...
	en: {
		...
		'about.p2': `I chase authenticity, not perfect poses. I work with people, brands, and athletes who want to tell their stories with strength and sensitivity.`,
		'about.p3': ``,
		'about.p4': `Have an idea in mind?`,
		'about.p5': `Let's chat and design your perfect shoot!`,
		'about.contact': `Let's talk!`,
		'about.quote': `Capturing life in vertical and emotions at street level.`,
		'photos.title': 'Photos',
